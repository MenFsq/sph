  ...
  methods: {
    ...
    async createWXCode() {
      ...
      let timer = setInterval(async () => {
        //检验支付的状态
        const code = await this.getPayState(
