<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-if="goodDetail.categoryView">{{
          goodDetail.categoryView.category1Name
        }}</span>
        <span v-if="goodDetail.categoryView">{{
          goodDetail.categoryView.category2Name
        }}</span>
        <span v-if="goodDetail.categoryView">{{
          goodDetail.categoryView.category3Name
        }}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="(attr, attrIndex) in goodDetail.spuSaleAttrList"
                :key="attr.id"
              >
                ...
                <dd
                  ...
                  :key="val.id"
                  v-for="(val, valIndex) in attr.spuSaleAttrValueList"
                  @click="activeFn({ attrIndex, valIndex })"
                >
